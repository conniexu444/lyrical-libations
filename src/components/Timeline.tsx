    ...
    <div>
      {timelineElements.map((element: TimelineElement) => (
        <div key={element.id} className="flex m-4 relative">
          ...
          <div className={`${colorClass} w-0.5 h-6 translate-x-20 translate-y-56 opacity-60 sm:hidden`} />
          <div className={`${colorClass} w-0.5 h-6 translate-x-80 translate-y-56 opacity-60 sm:hidden`} />
